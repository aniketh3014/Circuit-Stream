...
export const Blogcard = ({
    ...
    return <Link to={`/blog/${id}`}><div className="w-screen lg:max-w-5xl max-w-xl cursor-pointer bg-white border-b border-gray-200 shadow rounded-lg">
   ...
   <div>
    <div className="pt-2 font-serif" dangerouslySetInnerHTML={{ __html: content.slice(0, 150) + "..." }} />
   </div>
