                    ...
                    <div className="md:w-full">
                        <div className="p-10">
                            ...
                            <div className="text-gray-500 mt-2 text-center">
                                ...
                                <Link className="underline text-gray-600" to={"/signin"}>
                                    {" "}
                                    Sign in
                                </Link>
                            </div>
                            <div className="mt-4 px-4">
                                ...
                                <button
                                    type="button"
                                    onClick={Signup}
                                    className="w-full text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-300 font-semibold rounded-lg text-sm px-5 py-3 mt-4"
                                >
                                    Sign up
                                </button>
                            </div>
